   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq-default mode-line-format
                   (list
                    ...
                    ;;Check if there is a version control and display the current branch name
                    '(:eval (if vc-mode (propertize (concat " " (substring vc-mode 5) " ")
                                                    'face '(:foreground "white"))))

                    ;; Check if there is a Git project and display the project name
                    '(:eval (if (and (projectile-project-p) (fboundp 'projectile-project-name))
                                (propertize (concat " " (projectile-project-name) " ") 'face '(:foreground "light green"))))
